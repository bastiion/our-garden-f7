            ...
            {data && !loading && !error && (
                <Card className='data-table'>
                    <table>
                        <thead>
                        <tr>
                            <th onClick={() => setOrderBy('name')} className='label-cell'>Name</th>
                            <th onClick={() => setOrderBy('avgStars')} className='numeric-cell'>Average Stars</th>
                            <th onClick={() => setOrderBy('numReviews')} className='numeric-cell'>Reviews</th>
                        </tr>
                        </thead>
                        <tbody>
                        {data.User.map(n => {
